...
class Support_Title extends Widget_Base {
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .support-section .sec-title h5' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .support-section .sec-title h5' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
			'{{WRAPPER}} .support-section .sec-title h5' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',		
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .support-section .sec-title h5',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .support-section .sec-title h5' => 'color: {{VALUE}} !important',
				),
