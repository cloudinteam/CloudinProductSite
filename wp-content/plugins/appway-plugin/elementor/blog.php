...
////Block==========================
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content' => 'display: {{VALUE}} !important',
				),
			)
		);	
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content' => 'background: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content:hover' => 'background: {{VALUE}} !important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}  .news-block-one .inner-box .lower-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}  .news-block-one .inner-box .lower-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->start_controls_section(
			'postdate_settings',
			array(
				'label' => __( 'Post Date Setting', 'ecolab' ),
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .post-date' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .post-date' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
			'{{WRAPPER}} .news-block-one .inner-box .lower-content .post-date' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',		
				),
			)
		);
		$this->add_control(
			'subtitle_margin',
			array(
				'label'     => __( 'Post Margin', 'ecolab' ),
				'condition'    => array( 'show_subtitle' => 'show' ),
				'type'      => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' =>  ['px', '%', 'em' ],
			
				'selectors' => array(
					'{{WRAPPER}}  .news-block-one .inner-box .lower-content .post-date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}  .news-block-one .inner-box .lower-content .post-date i' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_subtitle' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} .news-block-one .inner-box .lower-content .post-date',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .post-date' => 'color: {{VALUE}} !important',
				),
...
//	// Title 	==================	
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content h3' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .news-block-one .inner-box .lower-content h3' => 'text-align: {{VALUE}} !important',
				),
			)
		);			
	...
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content h3' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_title' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} .news-block-one .inner-box .lower-content h3',
			)
		);
		$this->add_control(
			'title_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content h3 a' => 'color: {{VALUE}} !important',
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content h3 a:hover' => 'color: {{VALUE}} !important',
...
//	//Text==========================
		...
		$this->start_controls_section(
			'text_two_settings',
			array(
				'label' => __( 'Read More Setting', 'ecolab' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			)
		);
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .link-btn a' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .link-btn' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_text_two' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .link-btn a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_text_two' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} .news-block-one .inner-box .lower-content .link-btn a',
			)
		);
		$this->add_control(
			'text_two_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .link-btn a' => 'color: {{VALUE}} !important',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .news-block-one .inner-box .lower-content .link-btn a:hover' => 'color: {{VALUE}} !important',
				),
			)
		);
