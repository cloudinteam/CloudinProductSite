...
//// Title 	==================	
		...
		$this->start_controls_section(
			'title_settings',
			array(
				'label' => __( 'Percentage Text Setting', 'ecolab' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			)
		);
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .crm-programming .single-item .piechart span' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .crm-programming .single-item .piechart span' => 'text-align: {{VALUE}} !important',
				),
			)
		);			
	...
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .crm-programming .single-item .piechart span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_title' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} .crm-programming .single-item .piechart span',
			)
		);
		$this->add_control(
			'title_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .crm-programming .single-item .piechart span' => 'color: {{VALUE}} !important',
...
////Text==========================
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .crm-programming .single-item .text' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .crm-programming .single-item .text' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_text' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .crm-programming .single-item .text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_text' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} .crm-programming .single-item .text',
			)
		);
		$this->add_control(
			'text_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .crm-programming .single-item .text' => 'color: {{VALUE}} !important',
				),
			)
		);
