 ...
 * @since 1.0.0
 */
class Team_Overlay extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team Overlay', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'team_overlay',
			[
				'label' => esc_html__( 'Team Overlay', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
        ...
        <section class="centred <?php echo esc_attr($settings['sec_class']);?>">
        <div class="container">
            <div class="row">
