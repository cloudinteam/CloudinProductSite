...
//	//========== Nav Button with Background ===================================
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .clients-section .owl-theme .owl-dots .owl-dot span' => 'display: {{VALUE}} !important',
				),
			)
		);	
		$this->add_control(
			'navbtn_alingment',
			array(
				'label' => esc_html__( 'Nav Btn Alignment', 'ecolab' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => esc_html__( 'Left', 'ecolab' ),
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .clients-section .owl-dots' => 'text-align: {{VALUE}} !important',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .clients-section .owl-theme .owl-dots .owl-dot span' => 'background: {{VALUE}} !important',
				),
			)
		);	
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .clients-section .owl-theme .owl-dots .owl-dot.active span' => 'background: {{VALUE}} !important',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .clients-section .owl-theme .owl-dots .owl-dot span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' =>  ['px', '%', 'em' ],
				'selectors' => array(
					'{{WRAPPER}} .clients-section .owl-theme .owl-dots .owl-dot span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				'name' => 'nav_border',
				'condition'    => array( 'show_nav_button' => 'show' ),
				'selector' => '{{WRAPPER}} .clients-section .owl-theme .owl-dots .owl-dot span',
			)
		);
		$this->add_control(
			'border_radius',
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .clients-section .owl-theme .owl-dots .owl-dot span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
