...
class Feature5_3 extends Widget_Base {
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box h3' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .content_block_10 .content-box h3' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
			'{{WRAPPER}} .content_block_10 .content-box h3' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',		
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .content_block_10 .content-box h3',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box h3' => 'color: {{VALUE}} !important',
				),
...
////Text==========================
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .text' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .text' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_text' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_text' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} .content_block_10 .content-box .text',
			)
		);
		$this->add_control(
			'text_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .text' => 'color: {{VALUE}} !important',
				),
			)
		);
...
$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} #content_block_10 .content-box .btn-box' => 'display: {{VALUE}} !important',
				),
			)
		);		
$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn' => 'color: {{VALUE}} !important',
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn:hover' => 'color: {{VALUE}} !important',
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn i' => 'color: {{VALUE}} !important',
...
$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn' => 'background: {{VALUE}} !important',
				),
			)
		);	
$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn:before' => 'background: {{VALUE}} !important',
				),
			)
		);	
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn i' => 'background: {{VALUE}} !important',
				),
			)
		);
	$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
	...
	$this->add_control(
			...
			array(
				...
				'size_units' =>  ['px', '%', 'em' ],
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_button' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			array(
				...
				'selector' => '{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn i',
			)
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .content_block_10 .content-box .btn-box .theme-btn i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
