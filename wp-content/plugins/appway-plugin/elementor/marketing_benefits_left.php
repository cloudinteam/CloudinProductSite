...
////Text==========================
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .text' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .text' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_text' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_text' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} #content_block_27 .content-box .text',
			)
		);
		$this->add_control(
			'text_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .text' => 'color: {{VALUE}} !important',
				),
			)
		);
...
////Text==========================
	...
	$this->add_control(
			...
			array(
				...
				'default' => 'show',
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .list-item li' => 'display: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'toggle' => true,
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .list-item li' => 'text-align: {{VALUE}} !important',
				),
			)
		);	
	$this->add_control(
			...
			array(
				...
				'condition'    => array( 'show_text_list' => 'show' ),
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .list-item li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important',
				),
			)
		);
		$this->add_group_control(
			...
			array(
				...
				'condition'    => array( 'show_text_list' => 'show' ),
				'label'    => __( 'Typography', 'ecolab' ),
				'selector' => '{{WRAPPER}} #content_block_27 .content-box .list-item li',
			)
		);
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			array(
				...
				'selector' => '{{WRAPPER}} #content_block_27 .content-box .list-item li:before',
			)
		);
		$this->add_control(
			'text_list_color',
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .list-item li' => 'color: {{VALUE}} !important',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #content_block_27 .content-box .list-item li:before' => 'color: {{VALUE}} !important',
				),
			)
		);
